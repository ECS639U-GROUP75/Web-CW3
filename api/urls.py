...
from .views import main_spa, register_view, login_view, profile_view, get_users, logout_view, add_hobby, get_csrf_token, get_friend_requests, get_current_friends, accept_friend_request, reject_friend_request, send_friend_request
